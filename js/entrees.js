    ...
    $(document).ready(function() {
        ...
        submitBtn.click(function () {
            ...
            var newEntree = database.collection("Entree").doc();
        ...
        sgtTableElement.on('click', '.edit-btn', function () {
            ...
            var platFirestoreRef = database.collection("Entree").doc(plat_ID);
        ...
        function platEdit(platID) {
            database.collection("Entree").doc(platID).set({
                nom: $('#textNomPlat').val(),
        ...
        sgtTableElement.on('click', '.delete-btn', function () {
            var platFirestoreRef = database.collection("Entree").doc($(this).data('id'));
    ...
    function onLoadFunctions() {
        ...
        table.innerHTML = "";
        database.collection("Entree").get().then((querySnapshot) => {
            const table = document.getElementById("contenuPlats");
