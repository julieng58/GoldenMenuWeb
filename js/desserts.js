...
$(document).ready(function() {
    ...
    submitBtn.click(function () {
        ...
        var newEntree = database.collection("Dessert").doc();
    ...
    sgtTableElement.on('click', '.edit-btn', function () {
        ...
        var platFirestoreRef = database.collection("Dessert").doc(plat_ID);
    ...
    function platEdit(platID) {
        database.collection("Dessert").doc(platID).set({
            nom: $('#textNomPlat').val(),
    ...
    sgtTableElement.on('click', '.delete-btn', function () {
        var platFirestoreRef = database.collection("Dessert").doc($(this).data('id'));
...
function onLoadFunctions() {
    ...
    table.innerHTML = "";
    database.collection("Dessert").get().then((querySnapshot) => {
        const table = document.getElementById("contenuPlats");
