...
var database = firebase.firestore();
    ...
    $(document).ready(function() {
        ...
        submitBtn.click(function () {
            ...
            var newEntree = database.collection("EntreeCOVID").doc();
        ...
        sgtTableElement.on('click', '.edit-btn', function () {
            ...
            var platFirestoreRef = database.collection("EntreeCOVID").doc(plat_ID);
        ...
        function platEdit(platID) {
            database.collection("EntreeCOVID").doc(platID).set({
                nom: $('#textNomPlat').val(),
        ...
        sgtTableElement.on('click', '.delete-btn', function () {
            var platFirestoreRef = database.collection("EntreeCOVID").doc($(this).data('id'));
    ...
    function onLoadFunctions() {
        ...
        table.innerHTML = "";
        database.collection("EntreeCOVID").get().then((querySnapshot) => {
            const table = document.getElementById("contenuPlats");
