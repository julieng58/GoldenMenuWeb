...
$(document).ready(function() {
    ...
    submitBtn.click(function () {
        ...
        var newEntree = database.collection("DessertCOVID").doc();
    ...
    sgtTableElement.on('click', '.edit-btn', function () {
        ...
        var platFirestoreRef = database.collection("DessertCOVID").doc(plat_ID);
    ...
    function platEdit(platID) {
        database.collection("DessertCOVID").doc(platID).set({
            nom: $('#textNomPlat').val(),
    ...
    sgtTableElement.on('click', '.delete-btn', function () {
        var platFirestoreRef = database.collection("DessertCOVID").doc($(this).data('id'));
...
function onLoadFunctions() {
    ...
    table.innerHTML = "";
    database.collection("DessertCOVID").get().then((querySnapshot) => {
        const table = document.getElementById("contenuPlats");
